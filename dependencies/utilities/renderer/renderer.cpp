...
unsigned long render::fonts::velocity_font;
unsigned long render::fonts::Visitor9;
unsigned long render::fonts::TahomaBold12;
unsigned long render::fonts::niggerfont;
...
void render::initialize() {
	...
	render::fonts::velocity_font = interfaces::surface->font_create();
	render::fonts::Visitor9 = interfaces::surface->font_create();
	render::fonts::TahomaBold12 = interfaces::surface->font_create();
	render::fonts::niggerfont = interfaces::surface->font_create();

	interfaces::surface->set_font_glyph(render::fonts::watermark_font, "Tahoma", 14.4, 500, 0, 0, 0 /*font_flags::fontflag_dropshadow*/);
	interfaces::surface->set_font_glyph(render::fonts::esp_font_small, "Small Fonts", 9, 400, 0, 0, 0 /*font_flags::fontflag_outline*/);
	interfaces::surface->set_font_glyph(render::fonts::esp_font, "Small Fonts", 13, 400, 0, 0, 0 /*font_flags::fontflag_outline*/);
	interfaces::surface->set_font_glyph(render::fonts::velocity_font, "Tahoma", 24, 800, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::Visitor9, "Visitor TT2 BRK", 9, 400, 0, 0, font_flags::fontflag_outline); // unused
	interfaces::surface->set_font_glyph(render::fonts::TahomaBold12, "Tahoma Bold", 12, 400, 0, 0, font_flags::fontflag_dropshadow); // unused
	interfaces::surface->set_font_glyph(render::fonts::niggerfont, "Tahoma", 9.4, 500, 0, 0, 0 /*font_flags::fontflag_dropshadow*/);
